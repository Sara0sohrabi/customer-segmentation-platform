...
if selected_table:
    ...
    selected_fields = st.multiselect(
        ...
        options=stats_df["column_name"].tolist() if "stats_df" in locals() else [],
    ...
    # -------------------------------------------------
    if "stats_df" in locals() and selected_fields:
            ...
            try:
                ...
                if response.get("error"):
                    ...
                    if "result" in response:
                        ...
                        # نمودار ساده: اگر cluster وجود دارد
